            ...
            >
              <div className="prose prose-lg max-w-none">
                ...
                <section id="payment" className="mb-12">
                  ...
                  <p className="text-gray-600 mb-4">
                    All prices are listed in <img src="/ed.png" className='w-[20px] inline-block' alt="" /> (United Arab Emirates Dirham) and include VAT where applicable. We accept various payment methods as indicated on our checkout page.
                  </p>
                  <p className="text-gray-600 mb-4">
