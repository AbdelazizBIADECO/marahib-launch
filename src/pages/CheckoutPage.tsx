                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex justify-between">
                                ...
                                <div className="text-right">
                                  <p className="font-medium text-gray-900"><img src="/ed.png" className='w-[20px] inline-block' alt="" /> {(item.price * item.quantity).toLocaleString()}</p>
            ...
            <div className="bg-gray-50 rounded-lg p-6 sticky top-24 border border-gray-200">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900"><img src="/ed.png" className='w-[20px] inline-block' alt="" /> {cart.subtotal.toLocaleString()}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Shipping</span>
                  <span className="font-medium text-gray-900">
                    {shippingCost[shippingMethod] === 0 ? 'Free' : <><img src="/ed.png" className='w-[20px] inline-block' alt="" /> {shippingCost[shippingMethod]}</>}
                  </span>
                </div>
                {cart.discount > 0 && (
              ...
              <div className="space-y-4">
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  <span>Free shipping on orders over <img src="/ed.png" className='w-[20px] inline-block' alt="" /> 500</span>
                </div>
                <div className="flex items-center text-sm text-gray-600">
