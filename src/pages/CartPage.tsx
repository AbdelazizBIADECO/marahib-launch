          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                Discover our curated furniture collections and create your perfect space.
              </p>
              <Link
                to="/"
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                <span className={`text-xs px-2 py-1 rounded-full font-medium ${
                                  ...
                                  item.type === 'design-look' ? 'bg-purple-100 text-purple-700' :
                                  'bg-gray-100 text-gray-700'
                                }`}>
                                  {item.type === 'product' ? 'Individual Item' :
                                   item.type === 'room-style' ? 'Complete Room' :
                                   item.type === 'design-look' ? 'Design Look' :
                                   'Designer Collection'}
                                </span>
                              </div>
              ...
              <div className="space-y-6">
                ...
                >
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {cart.shipping === 0 ? (
                          ...
                          <><img src="/ed.png" className='w-[20px] inline-block' alt="" /> ${cart.shipping.toLocaleString()}</>
                        )}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center text-sm text-gray-600 mb-2">
                      ...
                      <span>
                        {cart.subtotal >= 500 
                          ...
                          : <>Add <img src="/ed.png" className='w-[20px] inline-block' alt="" /> {(500 - cart.subtotal).toLocaleString()} more for free shipping</>
                        }
                      </span>
                    </div>
                  ...
                  <div className="mt-4 text-center">
                    ...
                    <div className="flex items-center justify-center space-x-2">
                      <div className="w-10 h-6 bg-gray-200 rounded text-xs flex items-center justify-center font-bold">VISA</div>
                      <div className="w-10 h-6 bg-gray-200 rounded text-xs flex items-center justify-center font-bold">MC</div>
                      <div className="w-10 h-6 bg-gray-200 rounded text-xs flex items-center justify-center font-bold">AMEX</div>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="space-y-2 text-sm">
                    <Link to="/shipping-delivery" className="block text-gray-600 hover:text-gray-900 transition-colors">
                      Shipping & Delivery
                    </Link>
                    <Link to="/returns-exchanges" className="block text-gray-600 hover:text-gray-900 transition-colors">
                      Returns & Exchanges
                    </Link>
                    <Link to="/contact" className="block text-gray-600 hover:text-gray-900 transition-colors">
