...
import { Truck, Clock, Globe, MapPin, Package, AlertTriangle, HelpCircle } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                Free for orders over <img src="/ed.png" className='w-[20px] inline-block' alt="" /> 500
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex justify-between items-center pb-2 border-b border-gray-100">
                  <span className="text-gray-600">Orders under <img src="/ed.png" className='w-[20px] inline-block' alt="" /> 500</span>
                  <span className="font-medium text-gray-900"><img src="/ed.png" className='w-[20px] inline-block' alt="" /> 50</span>
                </li>
                <li className="flex justify-between items-center pb-2 border-b border-gray-100">
                  <span className="text-gray-600">Orders over <img src="/ed.png" className='w-[20px] inline-block' alt="" /> 500</span>
                  <span className="font-medium text-green-600">FREE</span>
                </li>
                <li className="flex justify-between items-center pb-2 border-b border-gray-100">
                  <span className="text-gray-600">Other UAE Emirates</span>
                  <span className="font-medium text-gray-900"><img src="/ed.png" className='w-[20px] inline-block' alt="" /> 75-150</span>
                </li>
                <li className="flex justify-between items-center">
                  <span className="text-gray-600">GCC Countries</span>
                  <span className="font-medium text-gray-900">From <img src="/ed.png" className='w-[20px] inline-block' alt="" /> 200</span>
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex justify-between items-center pb-2 border-b border-gray-100">
                  ...
                  <span className="font-medium text-gray-900">From <img src="/ed.png" className='w-[20px] inline-block' alt="" /> 250</span>
                </li>
                <li className="flex justify-between items-center pb-2 border-b border-gray-100">
                  <span className="text-gray-600">Assembly Service</span>
                  <span className="font-medium text-gray-900">From <img src="/ed.png" className='w-[20px] inline-block' alt="" /> 150</span>
                </li>
                <li className="flex justify-between items-center pb-2 border-b border-gray-100">
                  <span className="text-gray-600">Express Delivery (Dubai)</span>
                  <span className="font-medium text-gray-900"><img src="/ed.png" className='w-[20px] inline-block' alt="" /> 100</span>
                </li>
                <li className="flex justify-between items-center">
                  <span className="text-gray-600">Scheduled Delivery Window</span>
                  <span className="font-medium text-gray-900"><img src="/ed.png" className='w-[20px] inline-block' alt="" /> 75</span>
                </li>
              </ul>
            </motion.div>
          </div>
