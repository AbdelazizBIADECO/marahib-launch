      ...
      {isAuthenticated ? (
        <div className="space-y-3">
          ...
          <button
            ...
            className="mobile-nav-subitem flex items-center w-full text-left text-red-600"
          >
        ...
        <div className="bg-black text-white py-2">
          <div className="container-custom text-center">
            <p className="text-xs font-medium tracking-wider uppercase">
              Free shipping on orders over <img src="/ed.png" className='w-[20px] inline-block' alt="" /> 500
            </p>
          </div>
        </div>
          ...
          <div className="container-custom">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden lg:flex items-center space-x-8 flex-1">
                ...
                >
                  <Link to="/new" className="cursor-pointer flex items-center">
                ...
                <Link to="/virtual-stores" className="nav-link-minimal text-nowrap">
                  Virtual Stores
                </Link>
              ...
              {/* Search bar */}
              {/* <div className="hidden xl:flex items-center mx-6">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search"
                    className="pl-10 pr-4 py-2.5 w-40 border border-gray-200 focus:outline-none focus:border-black text-sm transition-all duration-200"
                  />
                </div>
              </div> */}
              ...
              <div className="flex items-center space-x-2">
                <Link to="/wishlist" className="icon-button-minimal">
                  <Heart size={18} />
                </Link>
                ...
                <div className="relative">
                  ...
                  {showUserMenu && isAuthenticated && <UserDropdown />}
                </div>
